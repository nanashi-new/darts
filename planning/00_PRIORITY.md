...
## P5 - Расширенная Функциональность v1.4

| Порядок | Задача | Статус | Task | Зависимости |
|---:|---|---|---|---|
| 25 | Расширенная аналитика турниров и игроков | done | - | v1.3 release |
| 26 | Новые форматы импорта (CSV/JSON/буфер) | done | - | v1.3 release |
| 27 | Настраиваемые отчеты и шаблоны | done | - | аналитика |
| 28 | Мультипрофильность | done | - | - |
| 29 | Интерактивная инструкция в приложении | done | - | - |
| 30 | Повышение автоматизации и UX | done | - | все P5 задачи |
| 31 | Экспорт протоколов в формате заказчика | done | - | аналитика/отчеты |
