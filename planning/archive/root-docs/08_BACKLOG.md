# 08 — Бэклог задач (справка)

> Active execution order has moved to [`planning/00_PRIORITY.md`](planning/00_PRIORITY.md).
> This backlog is historical/reference material. Do not use it as the current task queue until items are transferred into `planning/`.
