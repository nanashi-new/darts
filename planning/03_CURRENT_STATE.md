...
- ЕВСК/EBCK нужно убрать полностью из продукта, UI, документации и расчетов.
...
- Проверка `rg "ЕВСК|EBCK|DartsRatingEBCK" .` все еще показывает активные остатки бренда/ЕВСК; это зафиксировано как отдельные P0 задачи `rename-to-darts-liga.md` и `remove-evsk-ebck.md`.
